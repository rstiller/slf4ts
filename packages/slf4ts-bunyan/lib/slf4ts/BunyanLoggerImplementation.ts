 ...
 */
export class BunyanLoggerImplementation
  implements LoggerImplementation<Logger, [Logger.LoggerOptions]>
{
  private readonly loggers = new Map<string, Logger>();
  private readonly rootLoggers = new Map<string, Logger>();
  private builder: LoggerBuilder<any, [Logger.LoggerOptions]> = (
  ...
  public setLoggerBuilder(
    builder?: LoggerBuilder<Logger, [Logger.LoggerOptions]>,
  ): void {
